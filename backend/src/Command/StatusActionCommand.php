...
#[AsCommand(
    name: 'thepdi:status-action',
    description: 'When this command is called it scrapes the statuses, and created or updated entities based on what it scrapes.',
)]
class StatusActionCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->bus->dispatch(new StatusActionMessage, [ new DelayStamp($delay * 60 * 1000) ]);
