...
#[AsCommand(
    name: 'thepdi:circuit-action',
    description: 'When this command is called it scrapes the circuits, and created or updated entities based on what it scrapes.',
)]
class CircuitActionCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->bus->dispatch(new CircuitActionMessage, [ new DelayStamp($delay * 60 * 1000) ]);
