...
#[AsCommand(
    name: 'thepdi:manufacture-and-model-action',
    description: 'When this command is called it scrapes the manufactures and models, and creates or updates entities based on what it scrapes.',
)]
class ManufactureAndModelActionCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->bus->dispatch(new ManufactureAndModelActionMessage, [ new DelayStamp($delay * 60 * 1000) ]);
