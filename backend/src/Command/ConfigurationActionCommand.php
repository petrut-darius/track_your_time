...
#[AsCommand(
    name: 'thepdi:configuration-action',
    description: 'When this command is called it scrapes the configurations and created or updated entities based on what it scrapes.',
)]
class ConfigurationActionCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->bus->dispatch(new ConfigurationActionMessage(), [ new DelayStamp($delay * 60 * 1000) ]);
