...
#[AsCommand(
    name: 'thepdi:grade-action',
    description: 'When this command is called it scrapes the gradees, and created or updated entities based on what it scrapes.',
)]
class GradeActionCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->bus->dispatch(new GradeActionMessage, [ new DelayStamp($delay * 60 * 1000) ]);
