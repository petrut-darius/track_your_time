...
#[AsCommand(
    name: 'thepdi:country-action',
    description: 'When this command is called it scrapes the countries, and created or updated entities based on what it scrapes.',
)]
class CountryActionCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->bus->dispatch(new CountryActionMessage(), [ new DelayStamp($delay * 60 * 1000) ]);
